Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/3ff6ec258524c9746a24744212d14e22"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float3 x0, x1, x2;
				float3 conv = lerp(GreenWrapSH(wrap), GreenWrapSHOpt(wrap), (0.371 /*_LightingWrappedNormalization*/)); // Should try optimizing this...
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float3 directColor = _LightColor0.rgb * saturate(RTWrapFunc(poiLight.nDotL, (0.998 /*_LightingWrappedWrap*/), (0.371 /*_LightingWrappedNormalization*/))) * shadowAttenuation;
				float3 indirectColor = 0;
				#ifdef UNITY_PASS_FORWARDBASE
				indirectColor = ShadeSH9_wrapped(poiMesh.normals[(0.0 /*_LightingIndirectUsesNormals*/)], (0.998 /*_LightingWrappedWrap*/)) * poiLight.occlusion;
				#endif
				...
				float3 mathRamp = lerp(float3(1, 1, 1), saturate(lerp((float4(1,1,1,1) * indirectColor), float3(1, 1, 1), saturate(poiLight.rampedLightMap))), (1.0 /*_ShadowStrength*/));
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcap.rgb *= (0.58 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.048 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				float metallic = (0.626 /*_MochieMetallicMultiplier*/);
				...
				specularMask *= (0.095 /*_MochieSpecularStrength*/);
				...
				specular = poiLight.directColor * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(0.4320358,0.4320358,0.4320358,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * attenuation;
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					#if defined(VERTEXLIGHT_ON)
					for (int index = 0; index < 4; index++)
					{
						...
						vSpecular += poiLight.vColor[index] * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(0.4320358,0.4320358,0.4320358,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * poiLight.vAttenuation[index];
					}
					#endif
				}
				if ((0.0 /*_Specular2ndLayer*/) == 1)
				{
					...
					specular2 = poiLight.directColor * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(0.4320358,0.4320358,0.4320358,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * attenuation * (1.0 /*_MochieSpecularStrength2*/);
					if ((1.0 /*_LightingVertexLightingEnabled*/))
					{
						#if defined(VERTEXLIGHT_ON)
						for (int index = 0; index < 4; index++)
						{
							...
							vSpecular2 += poiLight.vColor[index] * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(0.4320358,0.4320358,0.4320358,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * poiLight.vAttenuation[index] * (1.0 /*_MochieSpecularStrength2*/);
						}
						#endif
					}
				}
				...
				reflections *= poiThemeColor(poiMods, float4(0.05278495,0.05278495,0.05278495,1), (0.0 /*_MochieReflectionTintThemeIndex*/));
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.2 /*_HighColor_Power*/), 5)), (0.016 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/);
				...
				{
					poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.3341808,0.3341808,0.3341808,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)) * specMask * poiLight.occlusion * attenuation * (1.0 /*_StylizedSpecularStrength*/));
				}
				else
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.3341808,0.3341808,0.3341808,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)), saturate(specMask * poiLight.occlusion * attenuation * (1.0 /*_StylizedSpecularStrength*/)));
				}
				float3 vSpecMask = 0;
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.2 /*_HighColor_Power*/), 5)), (0.016 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
						...
						if ((0.0 /*_Is_BlendAddToHiColor*/) == 1)
						{
							poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.3341808,0.3341808,0.3341808,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)) * vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/));
						}
						else
						{
							poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.3341808,0.3341808,0.3341808,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), saturate(vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/)));
						}
					}
					#endif
				}

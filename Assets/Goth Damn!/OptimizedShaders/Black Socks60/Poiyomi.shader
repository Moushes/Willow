Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/95bb354fe4e54c0a95a3c878569a440b"
{
	Properties
	{
 ...
 #define PROP_CUBEMAPMASK 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = lerp(float4(1,1,1,1) * lerp(poiLight.indirectColor, poiLight.rampedLightMap * poiLight.directColor, float(1)) * poiLight.occlusion, poiLight.directColor, poiLight.rampedLightMap);
				#endif
				#ifdef _LIGHTINGMODE_MULTILAYER_MATH

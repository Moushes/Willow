Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/b4a9ff18a2965db48a9189f9fd8936a1"
{
	Properties
	{
 ...
 #define PROP_CLIPPINGMASK 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + float(0.135));
			}
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), -float(-0.87) * hueShiftAlpha.b);
				poiFragData.baseColor = saturate(poiFragData.baseColor + float(-0.755) * hueShiftAlpha.g);
				#endif

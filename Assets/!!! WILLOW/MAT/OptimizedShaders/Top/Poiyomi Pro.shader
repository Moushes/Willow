Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/174d8d9e68cc6a24ea05d66775d426f0"
{
	Properties
	{
 ...
 #define PROP_DISSOLVENOISETEXTURE 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				poiFragData.emission += lerp(0, dissolveToTexture * float(1), dissolveAlpha) + lerp(0, edgeColor.rgb * float(0), smoothstep(0, 1 - float(0) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			//ifex float(1)==0

Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/2fd8c0e5b0874d8468fc396a9f5c9e10"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				reflectionMask *= float(0.47);
				specularMask *= float(2.83);
				if (float(0))
				{

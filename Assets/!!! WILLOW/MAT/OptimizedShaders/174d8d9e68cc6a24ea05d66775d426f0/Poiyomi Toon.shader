Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/174d8d9e68cc6a24ea05d66775d426f0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				poiFragData.emission += lerp(0, dissolveToTexture * 1.0, dissolveAlpha) + lerp(0, edgeColor.rgb * 0.0, smoothstep(0, 1 - 0.0 * .99999999999, edgeAlpha));
				#endif
			}
			#endif

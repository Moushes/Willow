Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro/ff31c35d8f64fb642bbf44a269faca3a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				+ (0.0 /*_DissolveAlpha8*/)
				+ (0.0 /*_DissolveAlpha9*/);
				float dds = (0.622 /*_DissolveDetailStrength*/);
				...
				if ((0.0 /*_EnableDissolveAudioLink*/) && poiMods.audioLinkAvailable)
				{
					...
					dds += lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(1.0 /*_AudioLinkDissolveDetailBand*/)]);
				}
				#endif
				da = saturate(da);
				dds = saturate(dds);
				...
				switch((1.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.051 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.051 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						if((1.0 /*_SphericalDissolveInvert*/))
						{
							da = remap(da, 1, 0, -(0.051 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.051 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((1.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.051 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.051 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
						if((1.0 /*_SphericalDissolveClamp*/))
						{
							da = lerp(da, 1 - da, (1.0 /*_SphericalDissolveInvert*/));
							dissolveAlpha = saturate(dissolveAlpha * smoothstep(0, 0.01, da) + smoothstep(0.99, 1, da));
							edgeAlpha *= smoothstep(0, 0.01, da);
						}
						break;
				...
				if ((0.051 /*_DissolveEdgeWidth*/) || ((1.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(10,10,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (10.0 /*_BumpScale*/));
				#else

Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro/1029a147b4dcf39489635a7993bd2b5d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/) && (1.5 /*_UVTileDissolveDiscardAtMax*/))
				{
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				+ (0.0 /*_DissolveAlpha8*/)
				+ (0.0 /*_DissolveAlpha9*/);
				float dds = (0.372 /*_DissolveDetailStrength*/);
				...
				switch((1.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.022 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.022 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					case 2: // Point to Point
					{
						...
						float3 currentPos;
						float distanceTo = 0;
						direction = normalize(float4(0,0.725,0,0) - float4(0,0.46,0,0));
						currentPos = lerp(float4(0,0.46,0,0), float4(0,0.725,0,0), dissolveAlpha);
						
						if ((2.0 /*_DissolveP2PWorldLocal*/) != 1)
						{
							float3 pos = (2.0 /*_DissolveP2PWorldLocal*/) == 0 ? poiMesh.localPos.rgb : poiMesh.vertexColor.rgb;
							distanceTo = dot(pos - currentPos, direction) - dissolveDetailNoise * dds;
							edgeAlpha = smoothstep((0.05 /*_DissolveP2PEdgeLength*/) + .00001, 0, distanceTo);
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.022 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.022 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.022 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.022 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
				...
				if ((0.022 /*_DissolveEdgeWidth*/) || ((1.0 /*_DissolveType*/) == 2 && (0.05 /*_DissolveP2PEdgeLength*/) != 0))
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(0,0.1529259,1,1).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(0,0.1529259,1,1).a);
					#ifndef POI_SHADOW
					...
					#endif
					poiFragData.baseColor = lerp(poiFragData.baseColor, edgeColor.rgb, smoothstep(0, 1 - (0.35 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				}
				poiFragData.emission += lerp(0, dissolveToTexture * (0.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (12.0 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.35 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			...
			{
				float3 x0, x1, x2;
				float3 conv = lerp(GreenWrapSH(wrap), GreenWrapSHOpt(wrap), (0.5 /*_LightingWrappedNormalization*/)); // Should try optimizing this...
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(0.3,0.3,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.3467041,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(0.3,0.3,0,0).xy) + _Time.x * (0.7 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.3467041,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.3467041,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				emissionColor0 = hueShift(emissionColor0, frac(_EmissionHueShift + (0.0 /*_EmissionHueShiftSpeed*/) * _Time.x) * _EmissionHueShiftEnabled);
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,0,0,0), (0.0 /*_EmissionAL0StrengthBand*/), float4(0.6,1.4,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), _EmissionAL0Enabled);
			...
			{
				float enviroRimAlpha = saturate(1 - smoothstep(min((0.0 /*_RimEnviroSharpness*/), (0.5 /*_RimEnviroWidth*/)), (0.5 /*_RimEnviroWidth*/), poiCam.vDotN));
				(0.65 /*_RimEnviroBlur*/) *= 1.7 - 0.7 * (0.65 /*_RimEnviroBlur*/);
				float3 enviroRimColor = 0;
				float interpolator = unity_SpecCube0_BoxMin.w;
				
				if (interpolator < 0.99999)
				{
					float4 reflectionData0 = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, poiMesh.normals[1], (0.65 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
					float3 reflectionColor0 = DecodeHDR(reflectionData0, unity_SpecCube0_HDR);
					float4 reflectionData1 = UNITY_SAMPLE_TEXCUBE_SAMPLER_LOD(unity_SpecCube1, unity_SpecCube0, poiMesh.normals[1], (0.65 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
				...
				{
					float4 reflectionData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, poiMesh.normals[1], (0.65 /*_RimEnviroBlur*/) * UNITY_SPECCUBE_LOD_STEPS);
				...
				#endif
				float3 envRimCol = lerp(0, max(0, (enviroRimColor - (0.0 /*_RimEnviroMinBrightness*/)) * poiFragData.baseColor), enviroRimAlpha).rgb * enviroMask * (0.2 /*_RimEnviroIntensity*/);

Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/7257c71afcc5b1645a316c4890b31dff"
{
	Properties
	{
 ...
 #define PROP_CUBEMAPMASK 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)), float(2.25));

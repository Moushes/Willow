Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/08675d7a552d85f4c8b38b57f6281e91"
{
	Properties
	{
		...
		[HideInInspector] s_start_MainHueShift_Eye_L ("Hue Shift--{reference_property:_MainHueShiftToggle,persistent_expand:true,default_expand:true}", Float) = 1
		...
		_MainHueShift_Eye_L ("Hue Shift", Range(0, 1)) = 0
		...
		[HideInInspector] s_end_MainHueShift_Eye_L ("Name Motion", Float) = 0

Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/e3eadcc034f46214998aab5d535e8852"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (-0.202 /*_AlphaMod*/));
			...
			void applyDithering(inout PoiFragData poiFragData, in PoiCam poiCam)
			{
				...
				{
					poiFragData.alpha = saturate(poiFragData.alpha - (calcDither(poiCam.screenUV) * (1 - poiFragData.alpha) * (1.0 /*_AlphaDitherGradient*/)));
				}
			}
			...
			struct PoiDecal
			{
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_Hair + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha_Hair 					 = _DecalBlendAlpha_Hair;
				...
				Decal1.m_DecalBlendAlpha_Hair 					 = _DecalBlendAlpha1_Hair;
				...
				Decal2.m_DecalBlendAlpha_Hair 					 = _DecalBlendAlpha2_Hair;
				...
				Decal3.m_DecalBlendAlpha_Hair 					 = _DecalBlendAlpha3_Hair;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), _MatcapMixed, matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.341 /*_Matcap2Mixed*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(4,4,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(4,4,0,0).xy) + _Time.x * (1.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				...
				{
					emissionStrength0 *= calculateBlinkingEmission((1.0 /*_EmissiveBlink_Min*/), (2.0 /*_EmissiveBlink_Max*/), (1.0 /*_EmissiveBlink_Velocity*/), (1.0 /*_EmissionBlinkingOffset*/));
				}
				applyLumaGradient(poiMods, emissionColor0, (0.0 /*_EmissionColorThemeIndex*/), poiLight.nDotV);
				emissionColor0 = hueShift(emissionColor0, frac(_EmissionHueShift_Hair + (0.0 /*_EmissionHueShiftSpeed*/) * _Time.x) * (1.0 /*_EmissionHueShiftEnabled*/));
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (800.0 /*_GlitterFrequency*/);
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					{
						randomRotation = randomFloat3WiggleRange(randoPoint, (20.0 /*_GlitterAngleRange*/), (0.0 /*_GlitterSpeed*/));
					}
					else
					{
					...
					finalGlitter = lerp(0, (0.1 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.43 /*_GlitterBias*/)), poiCam.viewDir)), (30.0 /*_GlitterContrast*/)), 0);
					...
					finalGlitter = max((0.1 /*_GlitterMinBrightness*/) * glitterAlpha, brightness * glitterAlpha * smoothstep(0, 1, 1 - m_dist * (0.08 /*_GlitterCenterSize*/) * 10));
					break;
					case 2:
					if ((0.0 /*_GlitterSpeed*/) > 0)
					{
					...
					finalGlitter = lerp(0, (0.1 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (30.0 /*_GlitterContrast*/)), 0);
				...
				#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				glitterColor *= POI2D_SAMPLER_PAN(_GlitterColorMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_GlitterColorMapUV*/)], float4(5,5,0,0)), float4(0,0,0,0)).rgb;
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float shift = (0.043 /*_MainHueShift*/);
					#ifdef POI_AUDIOLINK

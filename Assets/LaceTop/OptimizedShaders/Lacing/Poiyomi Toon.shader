Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/06c331701e316604f8434e125613ffe3"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.6038274,0.6038274,0.6038274,1).rgb, 0.0);
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - (0.5) * hueShiftAlpha.b);

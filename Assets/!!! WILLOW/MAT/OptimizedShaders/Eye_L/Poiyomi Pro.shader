Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/08675d7a552d85f4c8b38b57f6281e91"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_Eye_L ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_Saturation_Eye_L ("Saturation", Range(-1, 10)) = 0
		...
		_MainHueShift_Eye_L ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_Eye_L ("Hue Shift", Float) = 0
		...
		_DecalBlendAlpha_Eye_L ("Alpha", Range(0, 1)) = 1
		...
		_DecalHueShift_Eye_L ("Hue Shift--{condition_showS:(_DecalHueShiftEnabled==1)}", Range(0, 1)) = 0
		...
		_DecalBlendAlpha1_Eye_L ("Alpha", Range(0, 1)) = 1
		...
		_DecalHueShift1_Eye_L ("Hue Shift--{condition_showS:(_DecalHueShiftEnabled1==1)}", Range(0, 1)) = 0
		...
		_DecalBlendAlpha2_Eye_L ("Alpha", Range(0, 1)) = 1
		...
		_DecalHueShift2_Eye_L ("Hue Shift--{condition_showS:(_DecalHueShiftEnabled2==1)}", Range(0, 1)) = 0
		...
		_DecalBlendAlpha3_Eye_L ("Alpha", Range(0, 1)) = 1
		...
		_DecalHueShift3_Eye_L ("Hue Shift--{condition_showS:(_DecalHueShiftEnabled3==1)}", Range(0, 1)) = 0
 ...
 #define PROP_GLITTERMASK 
			...
			float _MainHueShift_Eye_L;
			float _MainHueShiftSpeed;
			float _Saturation_Eye_L;
			...
			float _DecalBlendAlpha_Eye_L;
			float _DecalOverrideAlpha;
			float _DecalHueShiftEnabled;
			float _DecalHueShift_Eye_L;
			...
			float _DecalBlendAlpha1_Eye_L;
			float _DecalOverrideAlpha1;
			float _DecalHueShiftEnabled1;
			float _DecalHueShift1_Eye_L;
			...
			float _DecalBlendAlpha2_Eye_L;
			float _DecalOverrideAlpha2;
			float _DecalHueShiftEnabled2;
			float _DecalHueShift2_Eye_L;
			...
			float _DecalBlendAlpha3_Eye_L;
			float _DecalOverrideAlpha3;
			float _DecalHueShiftEnabled3;
			float _DecalHueShift3_Eye_L;
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods, in PoiLight poiLight)
			{
				...
				#endif
				decalColor.rgb = decalHueShift(float(1), decalColor.rgb, _DecalHueShift_Eye_L + poiLight.nDotV * float(0), float(0));
				...
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, float(0)), decalColor.a * saturate(_DecalBlendAlpha_Eye_L + audioLinkDecalAlpha0));
				if (float(0))
				{
					alphaOverride += 1;
				...
				decalColor = float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, float(0)), float4(1,1,1,1).a);
				#endif
				decalColor.rgb = decalHueShift(float(1), decalColor.rgb, _DecalHueShift1_Eye_L + poiLight.nDotV * float(0), float(0));
				...
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, float(0)), decalColor.a * saturate(_DecalBlendAlpha1_Eye_L + audioLinkDecalAlpha1));
				if (float(0))
				{
					alphaOverride += 1;
				...
				decalColor = float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, float(0)), float4(1,1,1,1).a);
				#endif
				decalColor.rgb = decalHueShift(float(1), decalColor.rgb, _DecalHueShift2_Eye_L + poiLight.nDotV * float(0), float(0));
				...
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, float(0)), decalColor.a * saturate(_DecalBlendAlpha2_Eye_L + audioLinkDecalAlpha2));
				if (float(0))
				{
					alphaOverride += 1;
				...
				decalColor = float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, float(0)), float4(1,1,1,1).a);
				#endif
				decalColor.rgb = decalHueShift(float(1), decalColor.rgb, _DecalHueShift3_Eye_L + poiLight.nDotV * float(0), float(0));
				...
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, float(0)), decalColor.a * saturate(_DecalBlendAlpha3_Eye_L + audioLinkDecalAlpha3));
				if (float(0))
				{
					alphaOverride += 1;
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(1))
				{
					float shift = _MainHueShift_Eye_L;
					#ifdef POI_AUDIOLINK
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), -_Saturation_Eye_L * hueShiftAlpha.b);

Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/7e452f12b5e59bc4ca95bfebba43f004"
{
	Properties
	{
		...
		_DissolveAlpha_Sweatshirt ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define PROP_DISSOLVENOISETEXTURE 
			...
			float _DissolveAlpha_Sweatshirt;
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float da = _DissolveAlpha_Sweatshirt
				+ float(0)
				+ float(0)
				+ float(0)
				+ float(0)
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, float(0.012), float(0), _Matcap2Multiply, float(0), float(0), matcap2, matcap2Mask, float(0), float(0)
				#ifdef POI_BLACKLIGHT

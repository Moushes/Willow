Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/39ec397806fd48545ad5000410835727"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float3 x0, x1, x2;
				float3 conv = lerp(GreenWrapSH(wrap), GreenWrapSHOpt(wrap), (0.148 /*_LightingWrappedNormalization*/)); // Should try optimizing this...
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.681 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				shadowStrength = lerp(0, shadowStrength, _OutlineShadowStrength);
				#endif
				#ifdef _LIGHTINGMODE_WRAPPED
				#define GREYSCALE_VECTOR float3(.33333, .33333, .33333)
				float3 directColor = _LightColor0.rgb * saturate(RTWrapFunc(poiLight.nDotL, (1.1 /*_LightingWrappedWrap*/), (0.148 /*_LightingWrappedNormalization*/))) * shadowAttenuation;
				float3 indirectColor = 0;
				#ifdef UNITY_PASS_FORWARDBASE
				indirectColor = ShadeSH9_wrapped(poiMesh.normals[(0.0 /*_LightingIndirectUsesNormals*/)], (1.1 /*_LightingWrappedWrap*/)) * poiLight.occlusion;
				#endif
				...
				poiLight.rampedLightMap = saturate((poiLight.lightMap - (1 - (0.494 /*_LightingGradientEnd*/))) / saturate((1 - (0.102 /*_LightingGradientStart*/)) - (1 - (0.494 /*_LightingGradientEnd*/)) + fwidth(poiLight.lightMap)));
				float3 mathRamp = lerp(float3(1, 1, 1), saturate(lerp((float4(0.005536096,0.005536096,0.005536096,1) * indirectColor), float3(1, 1, 1), saturate(poiLight.rampedLightMap))), (0.681 /*_ShadowStrength*/));
				float3 finalWrap = directColor + indirectColor;
				if ((1.0 /*_LightingCapEnabled*/))
				{
					finalWrap = clamp(finalWrap, (1.0 /*_LightingMinLightBrightness*/), (1.51 /*_LightingCap*/));
				}
				else
				{
					finalWrap = max(finalWrap, (1.0 /*_LightingMinLightBrightness*/));
				}
				finalWrap *= attenuation;
				poiLight.finalLighting = finalWrap * saturate(mathRamp + 1 - (0.681 /*_ShadowStrength*/));
				#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcap.rgb *= (0.75 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.828 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (1.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			#ifdef _CUBEMAP
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				cubeMap.rgb *= (0.26 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, cubeMap.rgb, (0.105 /*_CubeMapReplace*/) * CubeMapMask * cubeMap.a);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections *= poiThemeColor(poiMods, float4(0.7433497,0.7433497,0.7433497,1), (0.0 /*_MochieReflectionTintThemeIndex*/));
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.7077566,0.7077566,0.7077566,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)) * specMask * poiLight.occlusion * attenuation * (1.0 /*_StylizedSpecularStrength*/));
				}
				else
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.7077566,0.7077566,0.7077566,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)), saturate(specMask * poiLight.occlusion * attenuation * (1.0 /*_StylizedSpecularStrength*/)));
				}
				float3 vSpecMask = 0;
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_BlendAddToHiColor*/) == 1)
						{
							poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.7077566,0.7077566,0.7077566,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)) * vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/));
						}
						else
						{
							poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.7077566,0.7077566,0.7077566,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), saturate(vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/)));
						}
					}
					#endif
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_LightingCapEnabled*/))
				{
					poiLight.directColor = min(poiLight.directColor, (1.51 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (1.51 /*_LightingCap*/));
				}

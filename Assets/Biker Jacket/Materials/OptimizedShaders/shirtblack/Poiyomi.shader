Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/0030bc026fa85b14089046bcb10b412d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float3 x0, x1, x2;
				float3 conv = lerp(GreenWrapSH(wrap), GreenWrapSHOpt(wrap), (0.177 /*_LightingWrappedNormalization*/)); // Should try optimizing this...
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.86 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				shadowStrength = lerp(0, shadowStrength, _OutlineShadowStrength);
				#endif
				#ifdef _LIGHTINGMODE_WRAPPED
				#define GREYSCALE_VECTOR float3(.33333, .33333, .33333)
				float3 directColor = _LightColor0.rgb * saturate(RTWrapFunc(poiLight.nDotL, (0.0 /*_LightingWrappedWrap*/), (0.177 /*_LightingWrappedNormalization*/))) * shadowAttenuation;
				...
				indirectColor = lerp(indirectColor, 1, (1.0 /*_LightingIgnoreAmbientColor*/));
				...
				poiLight.rampedLightMap = saturate((poiLight.lightMap - (1 - (0.266 /*_LightingGradientEnd*/))) / saturate((1 - (0.0 /*_LightingGradientStart*/)) - (1 - (0.266 /*_LightingGradientEnd*/)) + fwidth(poiLight.lightMap)));
				float3 mathRamp = lerp(float3(1, 1, 1), saturate(lerp((float4(0.1436938,0.1436938,0.1436938,1) * indirectColor), float3(1, 1, 1), saturate(poiLight.rampedLightMap))), (0.86 /*_ShadowStrength*/));
				...
				poiLight.finalLighting = finalWrap * saturate(mathRamp + 1 - (0.86 /*_ShadowStrength*/));
				#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.35 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.35 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.35 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				matcapUV = lerp(matcapUV, poiMesh.uv[(1.0 /*_MatcapUVToBlend*/)], float4(0,0,0,0).xy);
				matcapUV = RotateUV(matcapUV, (-0.25 /*_MatcapRotation*/) * PI, float2(.5, .5), 1.0f);
				if (IsInMirror())
				{
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.06083426,0.06083426,0.06083426,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.06083426,0.06083426,0.06083426,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.06083426,0.06083426,0.06083426,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.06083426,0.06083426,0.06083426,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.06083426,0.06083426,0.06083426,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.06083426,0.06083426,0.06083426,1).a);
				#endif
				matcap.rgb *= (1.02 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.044 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.343 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.343 /*_HighColor_Power*/), 5)), (0.043 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/);
				...
				{
					poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.0244657,0.0244657,0.0244657,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)) * specMask * poiLight.occlusion * attenuation * (1.0 /*_StylizedSpecularStrength*/));
				}
				else
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.0244657,0.0244657,0.0244657,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)), saturate(specMask * poiLight.occlusion * attenuation * (1.0 /*_StylizedSpecularStrength*/)));
				}
				float3 vSpecMask = 0;
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.343 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.343 /*_HighColor_Power*/), 5)), (0.043 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
						...
						if ((0.0 /*_Is_BlendAddToHiColor*/) == 1)
						{
							poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.0244657,0.0244657,0.0244657,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)) * vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/));
						}
						else
						{
							poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.0244657,0.0244657,0.0244657,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), saturate(vSpecMask * poiLight.occlusion * (1.0 /*_StylizedSpecularStrength*/)));
						}
					}
					#endif
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.7986599,0.7986599,0.7986599,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.7986599,0.7986599,0.7986599,1).a;

Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/6db9f7410487ab54c9e6241ee6f6ebc8"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.0.α10</color>", Float) = 0
		...
		[Vector3][VectorLabel(X, Y, Both)]_DecalScale ("Scale", Vector) = (1, 1, 1, 0)
		...
		[HideInInspector] s_start_Decal0GlobalMasking ("Global Masking--{persistent_expand:false, default_expand:false}", Float) = 0
		...
		[HideInInspector] s_end_Decal0GlobalMasking ("Global Masking", Float) = 0
		...
		[HideInInspector] m_start_LightDataBasePass ("Base Pass (Directional & Baked Lights)", Float) = 1
		...
		[HideInInspector] m_end_LightDataBasePass ("Base Pass", Float) = 1
		[HideInInspector] m_start_LightDataAddPass ("Add Pass (Point & Spot lights)", Float) = 1
		...
		[HideInInspector] m_end_LightDataAddPass ("Add Pass", Float) = 1
		[HideInInspector] m_start_LightDataDebug ("Debug / Data Visualizations--{reference_property:_LightDataDebugEnabled}", Float) = 0
		...
		[HideInInspector] m_end_LightDataDebug ("Debug", Float) = 0
		...
		[HideInInspector] g_start_liltoon_rim_lightdir ("Light Direction--{draw_border:true, condition_showS:_RimStyle==2}", Float) = 0
		...
		[HideInInspector] g_end_liltoon_rim_lightdir ("", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				return minNew + (x - minOld) * (maxNew - minNew) / max((maxOld - minOld), .001);
			}
			...
			float3 customBlend(float3 base, float3 blend, float blendType)
			{
				switch(blendType)
				{
					...
					case 7: return blendSubtract(base, blend); break;
			...
			void calculateGlobalThemes(inout PoiMods poiMods)
			{
				...
				poiMods.globalColorTheme[0] = float4(ApplyHDRExposure(ModifyViaHSV(themeColor0.rgb, frac(_GlobalThemeHue0 + _GlobalThemeHueSpeed0 * _Time.x), _GlobalThemeSaturation0, _GlobalThemeValue0), themeColorExposures.x), float4(1,1,1,1).a);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalColorThemeIndex = (1.0 /*_DecalColorThemeIndex*/);
				...
				Decal0.m_DecalHueShift = (0.411 /*_DecalHueShift*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.indirectColor = (0.0 /*_LightingAdditiveLimited*/) ? min((1.0 /*_LightingAdditiveLimit*/), poiLight.indirectColor) : poiLight.indirectColor;
				#endif
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0,0,1).rgb, (1.0 /*_ColorThemeIndex*/));
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (1.0 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (1.0 /*_RimWidth*/), (0.948 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0,0,0,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.0 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (0.55 /*_RimBrightness*/), (0.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef POI_RIM2
				#ifdef _RIM2STYLE_POIYOMI
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRim2Light*/), (1.0 /*_Rim2LightingInvert*/), (1.0 /*_Rim2Power*/), (0.0 /*_Rim2Strength*/), (0.0 /*_Rim2ShadowWidth*/), (0.0 /*_Rim2ShadowToggle*/), (0.401 /*_Rim2Width*/), (0.349 /*_Rim2BlendStrength*/), rim2Mask, (0.0 /*_Rim2GlobalMask*/), (2.0 /*_Rim2GlobalMaskBlendType*/), rim2Color, float4(1,1,1,1), (0.0 /*_Rim2LightColorThemeIndex*/), (0.0 /*_Rim2HueShiftEnabled*/), (0.0 /*_Rim2HueShift*/), (0.0 /*_Rim2HueShiftSpeed*/), (0.0 /*_Rim2Sharpness*/), (0.0 /*_Rim2ShadowMaskRampType*/), (0.0 /*_Rim2ShadowMaskInvert*/), (1.0 /*_Rim2ShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_Rim2ApplyGlobalMaskIndex*/), (2.0 /*_Rim2ApplyGlobalMaskBlendType*/), (0.0 /*_Rim2BaseColorMix*/), (0.03 /*_Rim2Brightness*/), (3.0 /*_RimPoi2BlendMode*/), AudioLinkRim2WidthBand, AudioLinkRim2WidthAdd, AudioLinkRim2EmissionBand, AudioLinkRim2EmissionAdd, AudioLinkRim2BrightnessBand, AudioLinkRim2BrightnessAdd, rim2Bias, (0.0 /*_Rim2BiasIntensity*/), (0 /*_Rim2ApplyAlpha*/), (1.0 /*_Rim2ApplyAlphaBlend*/));
				#endif
				#endif

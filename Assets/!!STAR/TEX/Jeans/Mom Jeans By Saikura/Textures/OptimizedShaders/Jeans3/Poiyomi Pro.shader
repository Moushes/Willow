Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/61833ba090cfeb7478e1e45567f6cac3"
{
	Properties
	{
		...
		_DissolveAlpha_Jeans3 ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define PROP_DISSOLVENOISETEXTURE 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float da = _DissolveAlpha_Jeans3
				+ float(0)
				+ float(0)
				+ float(0)
				+ float(0)

Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/08675d7a552d85f4c8b38b57f6281e91"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.7 /*_EmissionStrength*/);
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (500.0 /*_GlitterFrequency*/);
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					{
						randomRotation = randomFloat3WiggleRange(randoPoint, (31.0 /*_GlitterAngleRange*/), (10.0 /*_GlitterSpeed*/));
					}
					else
					{
						randomRotation = randomFloat3Range(randoPoint, (31.0 /*_GlitterAngleRange*/));
					}
					float3 glitterReflectionDirection = normalize(mul(poiRotationMatrixFromAngles(randomRotation), norm));
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.4 /*_GlitterBias*/)), poiCam.viewDir)), (30.0 /*_GlitterContrast*/)), 0);
				...
				glitterColor *= lerp(1, poiFragData.baseColor, (0.999 /*_GlitterUseSurfaceColor*/));
				#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)

Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/869ac752502b7604190ee71bcc10aef6"
{
	Properties
	{
 ...
 #define PROP_DISSOLVENOISETEXTURE 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, float(0), float(0), float(0.439), float(0), float(1), matcap2, matcap2Mask, float(0), float(0)
				#ifdef POI_BLACKLIGHT

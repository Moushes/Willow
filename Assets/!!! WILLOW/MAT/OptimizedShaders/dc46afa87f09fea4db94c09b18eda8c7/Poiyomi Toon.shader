Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/dc46afa87f09fea4db94c09b18eda8c7"
{
	Properties
	{
		...
		_EmissionHueShift_Horns ("Hue Shift", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if(1.0)
				{
					emissionColor0 = hueShift(emissionColor0, frac(_EmissionHueShift_Horns + 0.0 * _Time.x), 0.0, 1.0);

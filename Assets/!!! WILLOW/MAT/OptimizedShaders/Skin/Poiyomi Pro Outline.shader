Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro Outline/e4d92024ebac2bb40bb7169d97538425"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (-0.416 /*_AlphaMod*/));
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcap3.rgb *= (1.0 /*_Matcap3Intensity*/);
				#if defined(PROP_MATCAP3MASK) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, _Matcap3Add, (0.0 /*_Matcap3AddToLight*/), (0.0 /*_Matcap3Multiply*/), _Matcap3Replace, (0.0 /*_Matcap3Mixed*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (3.18 /*_BumpScale*/));
				#else
				...
				clip(poiFragData.alpha - (0.502 /*_Cutoff*/));

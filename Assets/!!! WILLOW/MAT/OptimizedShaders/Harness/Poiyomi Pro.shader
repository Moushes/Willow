Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/b7afe0e8e730b294d89970aa2b95429e"
{
	Properties
	{
 ...
 #define PROP_DISSOLVENOISETEXTURE 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, float(0), float(0), float(0), float(1), float(0), matcap3, matcap3Mask, float(0), float(0)
				#ifdef POI_BLACKLIGHT

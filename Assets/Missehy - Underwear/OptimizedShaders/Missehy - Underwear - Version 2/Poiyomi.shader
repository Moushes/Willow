Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/6e0823556acc1f14f8eb9653fadd1f01"
{
	Properties
	{
		...
		_MatcapHueShift_Missehy2DUnderwear2DVersion2 ("Hue Shift--{condition_showS:(_MatcapHueShiftEnabled==1)}", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _MatcapHueShift_Missehy2DUnderwear2DVersion2;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					matcap.rgb = hueShift(matcap.rgb, _MatcapHueShift_Missehy2DUnderwear2DVersion2 + _Time.x * (0.0 /*_MatcapHueShiftSpeed*/));
				}

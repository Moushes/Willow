Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/cb1b36c0c63382046bd27861fc9017b9"
{
	Properties
	{
		...
		_DissolveAlpha_Jeans4 ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define PROP_DISSOLVENOISETEXTURE 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float da = _DissolveAlpha_Jeans4
				+ float(0)
				+ float(0)
				+ float(0)
				+ float(0)

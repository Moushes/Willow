Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/09c504e4ef00c6d408504287f3626107"
{
	Properties
	{
		...
		_DissolveAlpha_Jeans5 ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define PROP_DISSOLVENOISETEXTURE 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float da = _DissolveAlpha_Jeans5
				+ float(0)
				+ float(0)
				+ float(0)
				+ float(0)
